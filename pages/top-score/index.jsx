		...
		<div className={styles.pagetopscore}>
			<Container maxWidth="xl">
				<div>
					...
					<div className={styles.tableleaderboardhead} style={{ borderBottom:"1px solid black", paddingTop:"50px", display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gridGap: 20 }}>
						<div>
							<Typography variant="h3"
								fontSize={{
									lg: 30,
					...
					<div className={styles.tableleaderboard}>
						{
							users.data.length > 0 ? users.data.sort((a, b) => a.total_score < b.total_score ? 1:-1).map((user, i) => (
								...
								<div key={i} className={styles.tableleaderboardrow} style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gridGap: 20 }}>
									<div>
										<Typography 
											fontSize={{
												lg: 20,
