...
import {
  Choice, Selection, ChoiceComputer, SelectionComputer,
} from '../components/RPSGame/choice/Choice.component';
  ...
  const play = (e) => {
    if (pcscore < winTarget) {
      ...
      if (userselection === pcselection) {
        ...
        resulttoupdate = 'DRAW';
      } else if ((userselection === 'Rock' && pcselection === 'Scissors') || (userselection === 'Paper' && pcselection === 'Rock') || (userselection === 'Scissors' && pcselection === 'Paper')) {
        dispatch(
          addScoreUser({
      ...
      const datatoupdate = {
        user_id: currentuserid, game_id: 1, result: resulttoupdate, score: scoretoupdate, game_date: currentyear,
      };
          ...
          <div className="game-container">
            <div className="game-section">
              <div className="info">
                <p className="headertitle">
                  PLAYER 1 (
                  <span id="playerScore">{userscore}</span>
                  )
                </p>
              </div>
              <br />
            ...
            <div className="game-section">
              <div className="info">
                <p className="headertitle">
                  COM (
                  <span id="playerScore">{pcscore}</span>
                  )
                </p>
              </div>
              <br />
